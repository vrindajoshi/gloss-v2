import svgPaths from "./svg-hz84hvouiy";

function App() {
  return <div className="absolute h-0 left-0 top-0 w-[562px]" data-name="App" />;
}

function Icon() {
  return (
    <div className="h-[16px] relative shrink-0 w-[8px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 16">
        <g id="Icon">
          <path d={svgPaths.p2b91ec00} id="Vector" stroke="var(--stroke-0, #FB64B6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.666667" />
          <path d={svgPaths.p37f5d000} id="Vector_2" stroke="var(--stroke-0, #FB64B6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.666667" />
          <path d={svgPaths.pc45d500} id="Vector_3" stroke="var(--stroke-0, #FB64B6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.666667" />
          <path d={svgPaths.p22079600} id="Vector_4" stroke="var(--stroke-0, #FB64B6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.666667" />
          <path d={svgPaths.pceebe80} id="Vector_5" stroke="var(--stroke-0, #FB64B6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.666667" />
          <path d={svgPaths.p225a8770} id="Vector_6" stroke="var(--stroke-0, #FB64B6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.666667" />
        </g>
      </svg>
    </div>
  );
...
function Container() {
  return (
    <div className="bg-gradient-to-b from-[#fccee8] h-[763px] relative shrink-0 to-[#ffd6a7] w-[8px]" data-name="Container">
...
function Heading() {
  return (
    <div className="flex-[1_0_0] h-[28px] min-h-px min-w-px relative" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[28px] left-0 text-[#171717] text-[18px] top-[0.5px] tracking-[0.32px]">Gloss</p>
      </div>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="h-[32px] relative shrink-0 w-[95.625px]" data-name="Container">
...
function Container2() {
  return (
    <div className="bg-gradient-to-r from-[#fdf2f8] h-[66px] relative shrink-0 to-[#fff7ed] w-[470px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#fccee8] border-b-2 border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-between pb-[2px] px-[24px] relative size-full">
        <Container3 />
        <Button />
      </div>
    </div>
...
function Paragraph() {
  return (
    <div className="bg-[#fafafa] h-[16px] relative shrink-0 w-[470px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Arimo:Italic',sans-serif] font-normal italic leading-[16px] left-[235.38px] text-[#737373] text-[12px] text-center top-0 tracking-[0.32px]">Simplify any article for easier reading</p>
      </div>
    </div>
  );
}
...
function PrimitiveLabel() {
  return (
    <div className="h-[24px] relative shrink-0 w-[112.641px]" data-name="Primitive.label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <p className="font-['Arimo:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[#171717] text-[16px] tracking-[0.32px]">Reading Level</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="bg-gradient-to-r from-[#fb64b6] h-[32px] relative rounded-[16777200px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.1)] shrink-0 to-[#ff8904] w-[86.383px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[20px] left-[16px] text-[14px] text-white top-[6px] tracking-[0.32px] w-[55px] whitespace-pre-wrap">Grade 8</p>
      </div>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="absolute bg-[#e5e5e5] content-stretch flex flex-col h-[16px] items-start left-0 overflow-clip pr-[211px] rounded-[16777200px] top-0 w-[422px]" data-name="Text">
      <Text3 />
    </div>
  );
}
...
function Slider() {
  return <div className="absolute bg-white border-2 border-[#fb64b6] border-solid left-[201px] rounded-[16777200px] shadow-[0px_4px_6px_0px_rgba(0,0,0,0.1),0px_2px_4px_0px_rgba(0,0,0,0.1)] size-[20px] top-[-2px]" data-name="Slider" />;
}
...
function Text4() {
  return (
    <div className="h-[16px] relative shrink-0 w-[45.602px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[16px] left-0 text-[#525252] text-[12px] top-0 tracking-[0.32px]">Grade 4</p>
      </div>
    </div>
  );
}
...
function Text5() {
  return (
    <div className="h-[16px] relative shrink-0 w-[52.594px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[16px] left-0 text-[#525252] text-[12px] top-0 tracking-[0.32px]">Grade 12</p>
      </div>
    </div>
  );
}
...
function PrimitiveLabel1() {
  return (
    <div className="content-stretch flex h-[24px] items-center relative shrink-0 w-full" data-name="Primitive.label">
      <p className="font-['Arimo:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[#171717] text-[16px] tracking-[0.32px]">Accessibility</p>
    </div>
  );
}
...
function Text6() {
  return (
    <div className="flex-[1_0_0] h-[20px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#404040] text-[14px] top-0 tracking-[0.32px]">Easy-Read Font</p>
      </div>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="h-[20px] relative shrink-0 w-[137.641px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[12px] items-center relative size-full">
        <Icon2 />
        <Text6 />
      </div>
...
function Text7() {
  return (
    <div className="flex-[1_0_0] h-[20px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#404040] text-[14px] top-0 tracking-[0.32px]">Text-to-Speech</p>
      </div>
    </div>
  );
}
...
function Text8() {
  return (
    <div className="flex-[1_0_0] h-[20px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#404040] text-[14px] top-0 tracking-[0.32px]">Focus Mode</p>
      </div>
    </div>
  );
}
...
function Container17() {
  return (
    <div className="h-[20px] relative shrink-0 w-[112.234px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[12px] items-center relative size-full">
        <Icon4 />
        <Text8 />
      </div>
...
function Container6() {
  return (
    <div className="bg-[#fafafa] flex-[1_0_0] min-h-px min-w-px relative w-[470px]" data-name="Container">
...
function Icon5() {
  return (
    <div className="absolute left-[140.45px] size-[16px] top-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
...
function Button1() {
  return (
    <div className="bg-gradient-to-r from-[#fb64b6] h-[56px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)] shrink-0 to-[#ff8904] w-full" data-name="Button">
      <Icon5 />
      <p className="-translate-x-1/2 absolute font-['Arimo:Bold',sans-serif] font-bold leading-[24px] left-[227.95px] text-[16px] text-center text-white top-[15.5px] tracking-[0.32px]">Simplify Page</p>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="bg-white h-[106px] relative shrink-0 w-[470px]" data-name="Container">
...
function Container1() {
  return (
    <div className="bg-white flex-[1_0_0] h-[763px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
        <Container2 />
        <Container5 />
      </div>
...
function ResizablePanel() {
  return (
    <div className="absolute bg-[#fafafa] content-stretch flex h-[763px] items-start left-[562px] pl-[2px] top-0 w-[480px]" data-name="ResizablePanel">
